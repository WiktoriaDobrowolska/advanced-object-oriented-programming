...
public class DataSource {
     ...
     * hsqldb.write_delay: If the property is true, the default WRITE_DELAY property of the database is used, which is 500 ms.
     * If the property is false, the WRITE_DELAY is set to 0 seconds.
     */
